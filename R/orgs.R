...
is.member.of.organization        <- function(ctx, org, user) api.test.request(ctx, c("orgs", org, "members", user))
...
is.public.member.of.organization <- function(ctx, org, user) api.test.request(ctx, c("orgs", org, "public_members", user))
...
is.member.in.team           <- function(ctx, id, user)        api.test.request(ctx, c("teams", id, "members", user))
...
is.repository.in.team       <- function(ctx, id, owner, repo) api.test.request(ctx, c("teams", id, "repos", owner, repo))
