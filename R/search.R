...
#' }
search.repositories <- api.function(function(ctx, q, ...) {
  params <- .rest(...)
  params$q <- q
...
#' }
search.code <- api.function(function(ctx, q, ...) {
  params <- .rest(...)
  params$q <- q
...
#' }
search.issues <- api.function(function(ctx, q, ...) {
  params <- .rest(...)
  params$q <- q
...
#' }
search.users <- api.function(function(ctx, q, ...) {
  params <- .rest(...)
  params$q <- q
