...
update.issue <- function(owner, repo, number, content, ctx = get.github.context())
...
update.issue.comment <- function(owner, repo, issue.number, comment.number, content, ctx = get.github.context())
...
update.repository.label <- function(owner, repo, name, content, ctx = get.github.context())
...
update.milestone <- function(owner, repo, milestone.number, content, ctx = get.github.context())
